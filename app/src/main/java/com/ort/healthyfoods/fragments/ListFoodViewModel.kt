...
class ListFoodViewModel : ViewModel() {
    ...
    fun initTestList () {
        comidas.add(Food(20,"Bowls de vegetales y verduras","Bowls de vegetales y verduras. Cuencos de preparación de comidas de verduras de invierno con col roja en escabeche, batata asada, brócoli, tofu ahumado y salsa mágica de tahini para hacer realidad todos tus sueños.",Food.Constants.tipoVegetariana,"https://www.heynutritionlady.com/wp-content/uploads/2018/01/winter_vegetable_meal_prep_bowls_3-500x453.jpg",1200))
