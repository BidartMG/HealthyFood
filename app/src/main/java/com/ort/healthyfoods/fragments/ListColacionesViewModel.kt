...
class ListColacionesViewModel : ViewModel() {
    ...
    fun initColaciones () {
        ...
        colaciones.add(Food(92,"Melón","Porción de 3 tajadas de melón",Food.Constants.tipoDulce,"https://fotos01.eldia.es/mmp/2019/06/24/1024x341/recetasconmelon.jpg",46))
